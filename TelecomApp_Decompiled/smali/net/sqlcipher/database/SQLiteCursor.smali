...
.method public commitUpdates(Ljava/util/Map;)Z
    ...
    const-string v13, "commitUpdates not supported on this cursor, did you include the _id column?"
    ...
    .line 435
    .local v5, "rowEntry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Long;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;>;"
    ...
    .line 436
    .local v10, "values":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    ...
    .line 438
    .local v8, "rowIdObj":Ljava/lang/Long;
    if-eqz v8, :cond_4
    ...
    const-string v15, "null rowId or values found! rowId = "
    ...
    .end local v5    # "rowEntry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Long;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;>;"
    .end local v8    # "rowIdObj":Ljava/lang/Long;
    .end local v9    # "sql":Ljava/lang/StringBuilder;
    .end local v10    # "values":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    :catchall_1
    move-exception v12
    ...
    .restart local v5    # "rowEntry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Long;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;>;"
    .restart local v8    # "rowIdObj":Ljava/lang/Long;
    .restart local v9    # "sql":Ljava/lang/StringBuilder;
    .restart local v10    # "values":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    :cond_5
    :try_start_4
    ...
    .line 452
    .local v11, "valuesIter":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/Object;>;>;"
    const/4 v12, 0x0
    ...
    iget-object v14, v0, Lnet/sqlcipher/database/SQLiteCursor;->mEditTable:Ljava/lang/String;
    ...
    .line 457
    .local v1, "bindings":[Ljava/lang/Object;
    const/4 v3, 0x0
    ...
    iget-object v14, v0, Lnet/sqlcipher/database/SQLiteCursor;->mColumns:[Ljava/lang/String;

    move-object/from16 v0, p0

    iget v15, v0, Lnet/sqlcipher/database/SQLiteCursor;->mRowIdColumnIndex:I
    ...
    invoke-virtual {v12, v14, v1}, Lnet/sqlcipher/database/SQLiteDatabase;->execSQL(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v12, v14, v6, v7}, Lnet/sqlcipher/database/SQLiteDatabase;->rowUpdated(Ljava/lang/String;J)V

    goto/16 :goto_1

    .line 475
    .end local v1    # "bindings":[Ljava/lang/Object;
    .end local v3    # "i":I
    .end local v5    # "rowEntry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Long;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;>;"
    .end local v6    # "rowId":J
    .end local v8    # "rowIdObj":Ljava/lang/Long;
    .end local v10    # "values":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    .end local v11    # "valuesIter":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/Object;>;>;"
    :cond_8
    move-object/from16 v0, p0
...
.method public requery()Z
    ...
    invoke-virtual {v3}, Lnet/sqlcipher/CursorWindow;->clear()V

    .line 532
    :cond_1
    const/4 v3, -0x1

    iput v3, p0, Lnet/sqlcipher/database/SQLiteCursor;->mPos:I
    ...
    invoke-virtual {v3}, Lnet/sqlcipher/database/SQLiteQuery;->requery()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
